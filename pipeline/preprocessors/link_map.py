...
LINK_MAPS: list[LinkMap] = [
    {
        ...
        "links": {
            ...
            "set_node_defaults": "langgraph/graph/state/StateGraph/set_node_defaults",
    ...
    },
    {
        ...
        "links": {
            ...
            "BaseDocumentLoader": "langchain-core/document_loaders/base/BaseDocumentLoader",
            ...
            "ForkedSubAgent": "deepagents/middleware/ForkedSubAgent",
            ...
            "Client.evaluate": "langsmith/evaluation/evaluate",
            "evaluate()": "langsmith/evaluation/evaluate",
            ...
            "useExtension": "langchain-react/useExtension",
            "useChannel": "langchain-react/useChannel",
            "StreamTransformer": "langchain-langgraph/index/StreamTransformer",
            "StreamChannel": "langchain-langgraph/index/StreamChannel",
        },
    },
    {
